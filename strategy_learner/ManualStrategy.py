...
if __name__ == "__main__":
    ...
    **************
    ...
    # Process orders
    print df_trades_ms
    portvals_ms = sim.compute_portvals(orders_file=df_trades_ms, start_val=sv, commission=9.95, impact=0.000)
    portvals_ms = portvals_ms / portvals_ms[0]

    ben_portval = sim.compute_portvals(orders_file=df_benchmark, start_val=sv, commission=9.95, impact=0.000)
